...
namespace Enki
{
	...
	EPuck::EPuck(unsigned capabilities) :
		DifferentialWheeled(5.1, 102.8, 0.05),
		infraredSensor0(this, Vector(3.35, -1.05),  2.5, -deg2rad(18), 120, 3731, 0.3, 0.7, 0),
		infraredSensor1(this, Vector(2.3, -2.6),  2.5, -deg2rad(45),   120, 3731, 0.3, 0.7, 0),
		infraredSensor2(this, Vector(0.0, -3.3),  2.5, -deg2rad(90),   120, 3731, 0.3, 0.7, 0),
		infraredSensor3(this, Vector(-3.0, -1.8), 2.5, -deg2rad(142),  120, 3731, 0.3, 0.7, 0),
		infraredSensor4(this, Vector(-3.0, 1.8),  2.5, deg2rad(142),   120, 3731, 0.3, 0.7, 0),
		infraredSensor5(this, Vector(0, 3.3),     2.5, deg2rad(90),    120, 3731, 0.3, 0.7, 0),
		infraredSensor6(this, Vector(2.3, 2.6),   2.5, deg2rad(45),    120, 3731, 0.3, 0.7, 0),
		infraredSensor7(this, Vector(3.35, 1.05),   2.5, deg2rad(18),  120, 3731, 0.3, 0.7, 0),
